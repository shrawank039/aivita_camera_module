package com.matrixdeveloper.aivita.Net.parser;
            ...
            if (jsonObj.has("data")) {
                ...
                if (dataObj != null) {
                    try {
                        ...
                        if (dataObj.has("fb_id")) {
                            authBean.setAuthToken(dataObj.optString("fb_id"));
                        }
                        ...
                        if (dataObj.has("user")) {
                            ...
                            if (userObj != null) {
                                ...
                                if (userObj.has("profile_photo")) {
                                   // authBean.setProfilePhoto(userObj.optString("profile_photo"));
                                }
                                if (userObj.has("name")) {
