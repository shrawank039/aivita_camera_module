package com.matrixdeveloper.aivita.Video_Recording.GallerySelectedVideo;
...
import com.matrixdeveloper.aivita.Video_Recording.Preview_Video_A;
...
import com.matrixdeveloper.aivita.SoundLists.SoundList_Main_A;
import com.matrixdeveloper.aivita.Video_Recording.Merge_Video_Audio;
...
public class GallerySelectedVideo_A extends AppCompatActivity implements View.OnClickListener,Player.EventListener{
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode== Video_Recoder_A.Sounds_list_Request_code){
            if(data!=null){
