package org.itniorwings.aivita.Videos;
...
import org.itniorwings.aivita.Videos.Following_Get_Set;
...
public class FollowingsAdapter extends RecyclerView.Adapter<FollowingsAdapter.CustomViewHolder > {

    public Context context;
    private FollowingsAdapter.OnItemClickListener listener;
    private ArrayList<Following_Get_Set> dataList;
    ...
    public interface OnItemClickListener {
        void onItemClick(int positon,Following_Get_Set item, View view);
    }



    public FollowingsAdapter(Context context, ArrayList<Following_Get_Set> dataList, FollowingsAdapter.OnItemClickListener listener) {
    ...
    @Override
    public FollowingsAdapter.CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewtype) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_home_layout,null);
        view.setLayoutParams(new RecyclerView.LayoutParams(RecyclerView.LayoutParams.MATCH_PARENT, RecyclerView.LayoutParams.MATCH_PARENT));
        FollowingsAdapter.CustomViewHolder viewHolder = new FollowingsAdapter.CustomViewHolder(view);
        return viewHolder;
    }
    ...
    @Override
    public void onBindViewHolder(final FollowingsAdapter.CustomViewHolder holder, final int i) {
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final int postion,final Following_Get_Set item, final FollowingsAdapter.OnItemClickListener listener) {
