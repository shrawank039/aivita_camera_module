...
public class Popular extends RootFragment implements Player.EventListener, Fragment_Data_Send {
...
*/
    ...
    public void Set_Adapter(){
        ...
        adapter=new PopularAdapter(context, data_list, new PopularAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(int positon, Popular_Get_Set item, View view) {
                switch(view.getId()) {
        ...
        try {
            ...
            if(code.equals("200")){
                ...
                for (int i=0;i<msgArray.length();i++) {
                    ...
                    Popular_Get_Set item=new Popular_Get_Set();
    ...
    public void Show_heart_on_DoubleTap(Popular_Get_Set item,final RelativeLayout mainlayout,MotionEvent e){
...
/*
    ...
    public void onDataSent(String yourData) {
        ...
        Popular_Get_Set item=data_list.get(currentPage);
    ...
    public void Like_Video(final int position, final Popular_Get_Set home_get_set){
    ...
    private void OpenComment(Popular_Get_Set item) {
    ...
    private void OpenProfile(Popular_Get_Set item,boolean from_right_to_left) {
    ...
    private void Show_video_option(final Popular_Get_Set home_get_set) {
    ...
    public void Save_Video(final Popular_Get_Set item){
    ...
    public void Applywatermark(final Popular_Get_Set item){
    ...
    public void Delete_file_no_watermark(Popular_Get_Set item){
    ...
    public void Scan_file(Popular_Get_Set item){
