package org.itniorwings.aivita.Following;
...
public class FollowingFragment extends Fragment {
    ...
    public FollowingFragment(Fragment_Callback fragment_callback) {
    ...
    private void Parse_following_data(String responce) {
    ...
    private void Parse_fans_data(String responce) {
        ...
        try {
            ...
            if (code.equals("200")) {
                ...
                if (datalist.isEmpty()) no_data_layout.setVisibility(View.VISIBLE);
                else no_data_layout.setVisibility(View.GONE);
    ...
    public void Follow_unFollow_User(final Following_Get_Set item, final int position) {
        ...
        if (item.follow.equals("0")) send_status = "1";
        else send_status = "0";
